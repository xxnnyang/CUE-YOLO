...
def get_params():
    params = {
        # 'weight': './runs/runs/train/GC-DET-yolo11/weights/best.pt',
        'weight': './runs/runs/train/GC-DET-yolo11-TADDH-C3k2-DAttention-EMASlideLoss/weights/best.pt',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    name = 'img_07_4406444100_00004.jpg'
    ...
    model(f'E:\\yxn\\ultralytics-yolo11-main\\dataset\\GC-DET-new\\train\\images\\{name}', f'./heatmap/{name}-11')
    ...
    model = yolov8_heatmap(**get_params())
    model(f'E:\\yxn\\ultralytics-yolo11-main\\dataset\\GC-DET-new\\train\\images\\{name}', f'./heatmap/{name}-our')
...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.last, self.best = self.wdir / "last.pt", self.wdir / "Detect-yolov11.pt"  # checkpoint paths
    ...
    def _do_train(self, world_size=1):
        ...
        if RANK in {-1, 0}:
            # Do final val with Detect-yolov11.pt
    ...
    def save_model(self):
        ...
        if self.best_fitness == self.fitness:
            # self.best.write_bytes(serialized_ckpt)  # save Detect-yolov11.pt
        ...
        for f in self.last, self.best:
            if f.exists():
                if f is self.last:
                    ...
                    k = "train_results"  # update Detect-yolov11.pt train_metrics from last.pt

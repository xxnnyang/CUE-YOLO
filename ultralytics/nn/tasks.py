...
DETECT_CLASS = (Detect, Detect_DyHead, Detect_AFPN_P2345, Detect_AFPN_P2345_Custom, Detect_AFPN_P345, Detect_AFPN_P345_Custom, Detect_Efficient, DetectAux, Detect_SEAM, Detect_MultiSEAM, 
                Detect_DyHeadWithDCNV3, Detect_DyHeadWithDCNV4, Detect_DyHead_Prune, Detect_LSCD, UTAH, Detect_LADH, Detect_LSCSBD, Detect_LSDECD)
...
C3K2_CLASS = (C3k2_Faster, C3k2_ODConv, C3k2_Faster_EMA, C3k2_DBB, C3k2_DeepDBB, C3k2_WDBB, C3k2_CloAtt, C3k2_SCConv, C3k2_ScConv, C3k2_EMSC, C3k2_EMSCP, C3k2_KW, C3k2_DySnakeConv, C3k2_DCNv2, C3k2_DCNv3,
              C3k2_OREPA, C3k2_REPVGGOREPA, C3k2_DCNv2_Dynamic, C3k2_ContextGuided, C3k2_MSBlock, C3k2_DLKA, C3k2_EMBC, C3k2_ASA, C3k2_Parc, C3k2_DWR, C3k2_RFAConv, C3k2_RFCBAMConv, C3k2_RFCAConv,
...
def torch_safe_load(weight, safe_only=False):
    ...
    ckpt, file = torch_safe_load("path/to/Detect-yolov11.pt", safe_only=True)
    ```
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            if m in ((C3k2,) + C3K2_CLASS) and scale in "mlx":  # for M/L/X sizes
                if m in (C3k2_AggregatedAtt, C3k2_MSBlock, C3k2_ASA, C3k2_FocusedLinearAttention, C3k2_Parc, C3k2_UniRepLKNetBlock, C3k2_SMPCGLU, C3k2_Heat, C3k2_RandomMixing, C3k2_RandomMixingCGLU):
                    if type(args[-1]) == bool:
                        args[-1] = True
                    else:
                        args[-2] = True
            ...
            if m in SEGMENT_CLASS:
                ...
                if m in (Segment_LSCD, Segment_TADDH, Segment_LSCSBD, Segment_LSDECD):
                    args[3] = make_divisible(min(args[3], max_channels) * width, 8)
            if m in (Detect_LSCD, UTAH, Detect_LSCSBD, Detect_LSDECD, v10Detect_LSCD):

...
model = YOLO("path/to/Detect-yolov11.pt")  # Load a custom trained model
...
yolo track model=path/to/Detect-yolov11.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/Detect-yolov11.pt tracker="bytetrack.yaml"
```
